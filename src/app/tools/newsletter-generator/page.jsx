...
export default function NewsletterGenerator() {
  ...
  return (
    <main className="max-w-4xl mx-auto px-6 py-16">
      <h1 className="text-3xl font-bold mb-6">Nyhedsbrev Generator</h1>
      <p className="text-sm text-gray-600 mb-6">
        Skriv et kort oplæg om, hvad nyhedsbrevet skal handle om – fx kampagner, arrangementer eller nye produkter.
      </p>
      ...
      <Button onClick={handleGenerate} disabled={loading || !input || (!isPro && usageLeft <= 0)}>
      ...
      {!isPro && usageLeft <= 0 && (
        <p className="text-sm text-red-600 mt-2">
          Du har brugt dine gratis genereringer for denne måned. Opgrader for ubegrænset adgang.
        </p>
      )}
